...
/* [DispensaryMainTest].[dbo].[uspDeleteChiperRecept] */

/* DispensaryMain.[dbo].[uspDeleteChiperRecept] */

CREATE PROCEDURE [dbo].[uspDeleteChiperRecept]
/***********************************************************
...
BEGIN
    ...
    DELETE FROM [dbo].[ChiperRecept]
    WHERE ChiperReceptID = @ChiperReceptID
