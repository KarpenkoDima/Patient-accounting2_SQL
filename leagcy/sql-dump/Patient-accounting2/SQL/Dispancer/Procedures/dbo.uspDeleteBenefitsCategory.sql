...
/* DispensaryMain.[dbo].[uspDeleteBenefitsCategory] */

CREATE PROCEDURE [dbo].[uspDeleteBenefitsCategory]
/***********************************************************
...
BEGIN
    ...
    DELETE FROM [dbo].[BenefitsCategory]
...
GRANT EXECUTE ON [dbo].[uspDeleteBenefitsCategory] TO [Sensitive_medium] AS [dbo]
GO
