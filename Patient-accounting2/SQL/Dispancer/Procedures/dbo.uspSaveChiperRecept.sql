...
/* [DispensaryMainTest].[dbo].[uspSaveChiperRecept] */

/* DispensaryMain.[dbo].[uspSaveChiperRecept] */

CREATE PROCEDURE [dbo].[uspSaveChiperRecept]
/***********************************************************
...
BEGIN
    ...
    IF @id IS NOT NULL
        SELECT @ChiperReceptID = @id
    ELSE SELECT @ChiperReceptID
    RETURN 0
END

GO

GRANT EXECUTE ON [dbo].[uspSaveChiperRecept] TO [Sensitive_medium] AS [dbo]
GO
